...
async function up() {
  ...
  await addCol('ALTER TABLE users ADD COLUMN department_id INT;');
  await addCol('ALTER TABLE users ADD COLUMN photo_url VARCHAR(255);');
  await addCol('ALTER TABLE users ADD COLUMN dob DATE;');
  await addCol('ALTER TABLE users ADD COLUMN address TEXT;');
  await addCol('ALTER TABLE users ADD COLUMN joining_date DATE;');
  await addCol('ALTER TABLE users ADD COLUMN is_active BOOLEAN DEFAULT TRUE;');
