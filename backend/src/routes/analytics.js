...
router.get('/', authenticate, cacheMiddleware('analytics:lead-source', 600), analyticsController.getLeadSourceAnalytics);
router.get('/dashboard', authenticate, cacheMiddleware('analytics:lead-source', 600), analyticsController.getLeadSourceAnalytics);
