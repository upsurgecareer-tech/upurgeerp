...
const roleColor = {
  ...
  couns: { bg: '#f3e8ff', color: '#9333ea', icon: '🎧' },
  facul: { bg: '#dcfce7', color: '#16a34a', icon: '👨‍🏫' },
  teacher: { bg: '#f5f3ff', color: '#6d28d9', icon: '📚' },
  account: { bg: '#ecfdf5', color: '#047857', icon: '📊' },
  cash: { bg: '#fff7ed', color: '#c2410c', icon: '💰' },
  recept: { bg: '#fdf2f8', color: '#be185d', icon: '🛎️' },
  coord: { bg: '#e0f2fe', color: '#0369a1', icon: '📋' },
  place: { bg: '#f0fdf4', color: '#15803d', icon: '🤝' },
  market: { bg: '#fef2f2', color: '#b91c1c', icon: '📢' },
  it: { bg: '#f1f5f9', color: '#334155', icon: '💻' },
  librar: { bg: '#fffbeb', color: '#b45309', icon: '📖' },
  trans: { bg: '#eff6ff', color: '#2563eb', icon: '🚌' },
  hostel: { bg: '#faf5ff', color: '#7e22ce', icon: '🏢' },
